...
export const MagicLinkEmail = ({ confirmationUrl }: Props) => (
  <Html lang="cs" dir="ltr">
    <Head />
    <Preview>Odkaz pro přihlášení do RadoClean</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>Váš přihlašovací odkaz</Heading>
        <Text style={text}>
          Klikněte níže pro přihlášení do RadoClean. Odkaz brzy vyprší.
        </Text>
        <Button style={button} href={confirmationUrl}>Přihlásit se</Button>
        <Hr style={hr} />
        <Text style={footer}>
          Pokud jste o odkaz nežádali, tento email ignorujte.<br />
