    ...
    try {
      ...
      if (error instanceof z.ZodError) {
        ...
        toast({
          ...
          description: "Zkuste to prosím znovu nebo nám zavolejte na +420 603 425 692",
          variant: "destructive"
        });
      }
    } finally {
            ...
            <div>
              {isSuccess ? <div className="flex flex-col items-center justify-center py-12 px-6 bg-primary/5 rounded-2xl border-2 border-primary/20">
                ...
                <div>
                  ...
                  <Input id="phone" type="tel" placeholder="+420 603 425 692" className={`h-12 ${errors.phone ? "border-destructive" : ""}`} value={formData.phone} onChange={handleChange} disabled={isSubmitting} />
                ...
                <p className="text-sm text-muted-foreground text-center">
                  ...
                  <a href="tel:+420603425692" className="text-primary hover:underline font-semibold ml-1">+420 603 425 692</a>
                </p>
              </form>}
            </div>
          </div>
